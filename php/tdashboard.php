...
if (isset($_POST['borrow_book'])) {
    ...
    if ($current_books >= $max_books) {
        ...
        if ($book && $book['quantity'] > 0) {
            ...
            $stmt3 = $conn->prepare("UPDATE book SET quantity = quantity - 1 WHERE book_id=?");
...
<head>
    ...
    <style>
        .alert { background-color: #f0f4c3; border-left:5px solid #cddc39; padding:10px; margin:10px 0;}
        .profile-panel form select { margin-top:5px; padding:5px; }
        .profile-panel form button { margin-top:5px; padding:5px 10px; }
    </style>
</head>
<body>
...
<header class="top-header">
    ...
    <div class="profile-menu">
        ...
        <div class="profile-panel" id="profilePanel">
            ...
            <?php if ($_SESSION['category'] === 'Teacher' || $_SESSION['category'] === 'Teacher_Admin'): ?>
                <form method="post" action="submit_admin_request.php">
                    <label for="requested_role">Request Role:</label>
                    ...
                    <a href="submit_admin_request.php" class="nav-btn">Submit Request</a>
                </form>
            <?php endif; ?>
...
<table>
<tr><th>Title</th><th>Due Date</th><th>Return</th></tr>
<?php
$today = date("Y-m-d");
$stmt = $conn->prepare(
...
<h3>Library Books</h3>
<table>
<tr><th>ID</th><th>Title</th><th>Author</th><th>Category</th><th>Quantity</th><th>Borrow</th></tr>
<?php
